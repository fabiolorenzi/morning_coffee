...
namespace Colours {
    inline const QColor background = QColor(244, 240, 238);
    inline const QColor primaryButton = QColor(106, 123, 140);
    inline const QColor primaryButtonHover = QColor(90, 104, 119);
    inline const QColor primaryButtonPressed = QColor(76, 88, 101);
